...
export function StateMap() {
  ...
  return (
    <div className="w-full h-full min-h-[500px] flex items-center justify-center relative p-8 bg-slate-50 border border-slate-100 rounded-xl overflow-hidden shadow-inner">
      <svg version="1.1" className="svg-mapa-brasil max-w-2xl w-full h-auto mx-auto drop-shadow-md" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 450 460" enableBackground="new 0 0 450 460" xmlSpace="preserve">
	<g>
		<g id="state-to" style={{ cursor: 'pointer' }}>

			<path      d="M289.558,235.641
			c16.104,0.575,44.973-31.647,44.835-45.259c-0.136-13.612-17.227-58.446-22.349-66.088c-5.122-7.628-37.905,2.506-37.905,2.506
			S234.852,233.695,289.558,235.641z" fill={activeUF === 'to' ? 'var(--color-primary)' : '#e2e8f0'} className={activeUF === 'to' ? 'transition-all duration-500 transform scale-[1.01] origin-center z-10' : 'transition-colors duration-300 hover:opacity-80 cursor-pointer'} stroke="var(--color-background)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
			<text  transform="matrix(1 0 0 1 287.0137 188.3208)"  fill={activeUF === 'to' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>TO</text>
		
</g>
		<g id="state-ba" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 359.7324 210.1221)"  fill={activeUF === 'ba' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>BA</text>
		
</g>
		<g id="state-se" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 408.9121 198.6689)"  fill={activeUF === 'se' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>SE</text>
		
</g>
		<g id="state-pe" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 401.3984 165.8003)"  fill={activeUF === 'pe' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>PE</text>
		
</g>
		<g id="state-al" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 429.7891 183.895)"  fill={activeUF === 'al' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>AL</text>
		
</g>
		<g id="state-rn" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 422.541 123.9009)"  fill={activeUF === 'rn' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>RN</text>
		
</g>
		<g id="state-ce" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 386.8379 129.0347)"  fill={activeUF === 'ce' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>CE</text>
		
</g>
		<g id="state-pi" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 355.127 158.1045)"  fill={activeUF === 'pi' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>PI</text>
		
</g>
		<g id="state-ma" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 318.2754 126.7036)"  fill={activeUF === 'ma' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>MA</text>
		
</g>
		<g id="state-ap" style={{ cursor: 'pointer' }}>

			<path      d="M225.198,39.089
			c3.274,1.165,3.985-1.315,6.572-1.74c3.616-0.603,5.683,2.725,9.037,2.067c4.055-0.78,7.093-8.025,7.314-11.598
			c4.492-3.534,5.503-11.258,9.42-14.68c6.055,4.258,6.11,15.788,7.589,22.485c-0.164,0.083,6.57,7.998,7.944,8.682
			c3.396,1.657,3.366,6.203,0.078,9.34c-3.777,3.587-7.449,34.275-7.449,34.275h-46.489c0,0,0.932-50.366,0-51.449
			C221.814,36.458,223.334,38.417,225.198,39.089z" fill={activeUF === 'ap' ? 'var(--color-primary)' : '#e2e8f0'} className={activeUF === 'ap' ? 'transition-all duration-500 transform scale-[1.01] origin-center z-10' : 'transition-colors duration-300 hover:opacity-80 cursor-pointer'} stroke="var(--color-background)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
			<text  transform="matrix(1 0 0 1 245.9023 52.6099)"  fill={activeUF === 'ap' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>AP</text>
		
</g>
		<g id="state-pa" style={{ cursor: 'pointer' }}>
			...
			C319.302,76.912,319.74,78.76,319.139,77.664z" fill={activeUF === 'pa' ? 'var(--color-primary)' : '#e2e8f0'} className={activeUF === 'pa' ? 'transition-all duration-500 transform scale-[1.01] origin-center z-10' : 'transition-colors duration-300 hover:opacity-80 cursor-pointer'} stroke="var(--color-background)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
			<text  transform="matrix(1 0 0 1 232.7725 122.5137)"  fill={activeUF === 'pa' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>PA</text>
		
</g>
		<g id="state-rr" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 136.2939 42.3862)"  fill={activeUF === 'rr' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>RR</text>
		
</g>
		<g id="state-am" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 98.1406 119.0591)"  fill={activeUF === 'am' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>AM</text>
		
</g>
		<g id="state-ac" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 47.7017 184.9355)"  fill={activeUF === 'ac' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>AC</text>
		
</g>
		<g id="state-ro" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 118.1299 195.3193)"  fill={activeUF === 'ro' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>RO</text>
		
</g>
		<g id="state-mt" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 200.0244 218.4175)"  fill={activeUF === 'mt' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>MT</text>
		
</g>
		<g id="state-ms" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 213.2939 306.7236)"  fill={activeUF === 'ms' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>MS</text>
		
</g>
		<g id="state-go" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 266.9111 254.2139)"  fill={activeUF === 'go' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>GO</text>
		
</g>
		<g id="state-pr" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 248.4453 356.1045)"  fill={activeUF === 'pr' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>PR</text>
		
</g>
		<g id="state-sc" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 266.9111 387.7646)"  fill={activeUF === 'sc' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>SC</text>
		
</g>
		<g id="state-rs" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 231.0313 414.4658)"  fill={activeUF === 'rs' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>RS</text>
		
</g>
		<g id="state-sp" style={{ cursor: 'pointer' }}>
			...
			C247.982,330.386,239.876,331.21,239.3,330.554z" fill={activeUF === 'sp' ? 'var(--color-primary)' : '#e2e8f0'} className={activeUF === 'sp' ? 'transition-all duration-500 transform scale-[1.01] origin-center z-10' : 'transition-colors duration-300 hover:opacity-80 cursor-pointer'} stroke="var(--color-background)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
			<text  transform="matrix(1 0 0 1 280.6816 327.3193)"  fill={activeUF === 'sp' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>SP</text>
		
</g>
		<g id="state-mg" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 328.4063 286.4561)"  fill={activeUF === 'mg' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>MG</text>
		
</g>
		<g id="state-rj" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 347.4648 334.6807)"  fill={activeUF === 'rj' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>RJ</text>
		
</g>
		<g id="state-es" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 373.3047 300.4971)"  fill={activeUF === 'es' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>ES</text>
		
</g>
		<g id="state-df" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 292.4141 254.2139)"  fill={activeUF === 'df' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>DF</text>
		
</g>
		<g id="state-pb" style={{ cursor: 'pointer' }}>
			...
			<text  transform="matrix(1 0 0 1 425.2129 148.9893)"  fill={activeUF === 'pb' ? '#ffffff' : '#64748b'}  style={{fontSize: '11px', fontWeight: 'bold'}}>PB</text>
