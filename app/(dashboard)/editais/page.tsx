        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-4">
            <button 
              ...
              className="px-6 py-3 rounded-xl font-bold text-slate-600 hover:bg-slate-100 transition-colors uppercase text-xs tracking-widest"
            >
              Cancelar
            </button>
            <button 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
              <h3 className="text-xl font-black font-headline text-slate-900 uppercase tracking-tight mb-8">Informações Básicas</h3>
              ...
              <form id="edital-form" onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    required
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-xl px-4 py-4 focus:border-primary transition-all outline-none font-medium text-lg"
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      type="date" 
                      required
                      className="w-full bg-slate-50 border-2 border-slate-100 rounded-xl px-4 py-4 focus:border-primary transition-all outline-none font-medium text-slate-700"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Arquivo do Edital (PDF)</label>
                  <div className="flex items-center gap-4">
                    <label className="flex-1 flex items-center justify-center gap-3 bg-slate-50 hover:bg-slate-100 text-slate-700 px-6 py-8 rounded-2xl cursor-pointer transition-colors border-2 border-dashed border-slate-300 font-bold group">
                    ...
                    {formData.arquivo_pdf_base64 && (
                      <div className="flex flex-col gap-2">
                        <button 
                          ...
                          className="p-4 bg-slate-100 hover:bg-slate-200 text-primary rounded-xl transition-colors shadow-sm"
                          title="Visualizar"
                        >
                        ...
                        <button 
                          ...
                          className="p-4 bg-red-50 hover:bg-red-100 text-red-500 rounded-xl transition-colors shadow-sm"
                          title="Remover"
                        >
                          <Trash2 size={20} />
                        </button>
          ...
          <div className="bg-slate-50 rounded-3xl border border-slate-200 flex flex-col h-full min-h-[600px]">
            <div className="p-8 border-b border-slate-200">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-black font-headline text-slate-900 uppercase tracking-tight">Adesões ao Edital</h3>
            ...
            <div className="flex-1 p-8 overflow-y-auto">
              {!editingEdital ? (
                 <div className="h-full flex flex-col items-center justify-center text-center p-8 bg-white rounded-2xl border-2 border-dashed border-slate-200">
                ...
                <div className="h-full flex flex-col items-center justify-center text-slate-400 bg-white rounded-2xl">
                ...
                <div className="space-y-4">
                  {submissions.map(sub => (
                    <div key={sub.id} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all group border-l-4 border-l-primary">
                      ...
                      <h4 className="font-black text-slate-900 uppercase text-sm mb-1 leading-tight">{sub.nome_entidade}</h4>
                      <div className="space-y-2">
                        <div className="flex gap-2">
                           <p className="text-xs text-slate-500 font-bold shrink-0">Projeto:</p>
                           <p className="text-xs text-slate-700 font-medium">{sub.nome_projeto}</p>
                        </div>
